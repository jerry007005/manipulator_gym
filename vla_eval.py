...
def main(_):
    ...
    checkpoint_path = "/home/hxu612/projects/haochuan/embodiedAI/runs/openvla-7b+uoa_orig+b16+lr-0.0005+lora-r32+dropout-0.0"
    ...
    try:
        for _ in range(100):
            ...
            for i in range(100):
                ...
                # image_cond.save(f"vla_eval_image_cond_{i}.png")  # save the image condition for debugging
